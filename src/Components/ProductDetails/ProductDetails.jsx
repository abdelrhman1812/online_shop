...
export default function ProductDetails() {
  ...
  return <>
    ...
    <MainHeader name={data?.data.data.title.split(" ").slice(0, 2).join(" ")} />
    <div className='product-detaisl '>
        ...
        <div className='Ttanding-products'>
          <div className='container'>
            ...
            <div className='row gy-3'>
              ...
              <h2 className='p-5'>Similar Products </h2>
              {isLoading ? <Loading /> : ""}
              {filteredProducts.map((product) => <div key={product.id} className=' col-md-4'>
