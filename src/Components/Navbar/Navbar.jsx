      ...
      <div className="container">
        ...
        <div className='logo'>
          <Link className="navbar-brand" to="/">
            ...
            <span className='dark'>Online Shop</span>
          </Link>
        </div>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {/* Links */}
          <ul className="navbar-nav links d-flex justify-content-center align-items-center mx-auto ">
            {userToken !== null ?
              <>
          ...
          <span className='  d-none d-lg-block m-0'>
